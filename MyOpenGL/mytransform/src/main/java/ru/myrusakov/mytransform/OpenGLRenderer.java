package ru.myrusakov.mytransform;
...
public class OpenGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        Matrix.translateM(matrixTransform, 0, 0, 1, 0);
        createMatrixResult();
        ...
        /*Matrix.setIdentityM(matrixTransform, 0);
        Matrix.translateM(matrixTransform, 0, -2, 0, 0);
        Matrix.scaleM(matrixTransform, 0, 0.5f, 2, 1);*/

        count += SPEED;
        if (count > 1) count = 0;

        Matrix.rotateM(matrixTransform, 0, (float) count * 360, 1, 1, -1);
        createMatrixResult();
